...
<section class="content ">
    <div class="container d-none d-md-block">
        ...
        <div class="text-center p-5">
            ...
            <form class="container card p-3 p-md-5" action="/startjob/create1/store" method="post" enctype="multipart/form-data">
                ...
                {{-- end mobile  --}}
                    ...
                    <fieldset class=" p-md-5  " style="padding-bottom:140px !important;">
                        ...
                        <input type="hidden" name="tags" value="{{$designer->tag}}">
...
<script src="{{asset('js/previewmultiple.js')}}"></script>
