...
<section class="showpayment">
    <div class="container bg-white mt-5 shadow-sm ">
        ...
        <div class="container">
          <div class="form-row pl-pr-lg-_ex  mt-5">
            <div class="form-group col-md-12">
              ...
              <div class="row text-left show-payment p-3 border mb-5">
                <div class="col-md-1">
              ...
              <div class=" text-left bg-white p-3 border mb-5">
        ...
        <a href="{{ route('job.payment', $jobs->token) }}">
          <button type="submit" class="btn btn-dark text-center mb-5">อัพโหลดหลักฐานการชำระเงิน</button>
        </a>
      </div>
    </div>
</section>
