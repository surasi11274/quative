...
@section('content')
    <section class="content">
        <div class="container">
            ...
            <div class="row p-5">
                <div class="col-6 ">
                    <a class="btn btn-primary btn-lg btn-block"  href="match.html">ย้อนกลับ</a>
                </div>
                <div class="col-6">
                    <button id="myDiv"  type="button" class="btn btn-primary btn-lg btn-block" data-toggle="modal" data-target="#exampleModalCenter">
                        บันทึกข้อมูล
                    </button>
                    <!-- Modal -->
